...
var GameInfo = function () {
    ...
    var Game = function () {
        ...
        this.lottery = function (userId, nBetSum, gameJackpot, redisIconTypeBind) {
            ...
            // 日志记录
            lottery_record.record(this._Csocket, 4096, gameConfig.serverId, gameConfig.gameId, userId, nBetSum, winscore, score_before, score_current, freeCount, sourceFreeCount,
