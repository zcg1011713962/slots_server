...
--
-- Host: localhost    Database: ym_manage
-- ------------------------------------------------------
...
CREATE TABLE `app_version` (
  ...
  `name` varchar(100) COLLATE utf8mb4_german2_ci NOT NULL DEFAULT '' COMMENT '游戏名称',
  `version` varchar(100) COLLATE utf8mb4_german2_ci NOT NULL DEFAULT '' COMMENT '版本号：1.0.0',
  `desc` varchar(255) COLLATE utf8mb4_german2_ci NOT NULL DEFAULT '' COMMENT '描述',
  `url` varchar(255) COLLATE utf8mb4_german2_ci NOT NULL DEFAULT '' COMMENT '安装包地址',
  `status` tinyint(3) unsigned NOT NULL DEFAULT '1' COMMENT '状态：1正常，2关闭',
  `is_force` tinyint(3) unsigned NOT NULL DEFAULT '2' COMMENT '是否强制更新：1是，2否',
  `delete_at` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '是否删除：1是，0否',
  `created_at` datetime DEFAULT NULL COMMENT '创建时间',
  `updated_at` datetime DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_german2_ci COMMENT='app版本升级表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `app_version` VALUES (1,'卡牌','v1.0','','',1,2,0,NULL,NULL);
...
CREATE TABLE `feedback` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=19 DEFAULT CHARSET=utf8mb4 COMMENT='意见反馈表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `rank_award` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `userId` bigint(20) DEFAULT NULL COMMENT '奖励的用户',
  `type` int(3) NOT NULL COMMENT '1金币排行奖励2充值排行奖励3大富豪排行奖励',
  `goods_type` varchar(50) NOT NULL COMMENT '奖励物品类型',
  `val` decimal(20,2) NOT NULL COMMENT '奖励物品数量',
  `rank_start_time` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '赛季开始时间',
  `rank_end_time` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '赛季开始时间',
  `create_time` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  `status` int(3) DEFAULT '0' COMMENT '领取状态 0未领取 1领取',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `rank_award`
--

LOCK TABLES `rank_award` WRITE;
/*!40000 ALTER TABLE `rank_award` DISABLE KEYS */;
/*!40000 ALTER TABLE `rank_award` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2024-08-07 19:03:06
